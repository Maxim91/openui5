...
], function (ManagedObject, jQuery, UriParameters, merge, sinon) {
	"use strict";
		...
		init: function () {
			...
			function generateResponse(fServer) {
				fServer.respondWith("GET", /\/sap\/opu\/odata4\/IWBEP\/V4_SAMPLE\/default\/IWBEP\/V4_GW_SAMPLE_BASIC\/0001\//, function (xhr, id) {
					var oParams = new UriParameters(xhr.url);
					var sFilter = oParams.get("$filter");
					var oFilteredData = merge({}, mockData);
